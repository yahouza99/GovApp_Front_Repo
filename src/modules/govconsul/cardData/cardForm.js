...
const CardForm = ({ initial, onCancel, onSave }) => {
  const [form, setForm] = useState(() => ({
    request_id: initial?.request_id || null,
    citizen_id: initial?.citizen_id || '',
    org_id: initial?.org_id || defaultOrgId,
    request_type_id: initial?.request_type_id || 201, // Carte consulaire par défaut
    request_title: initial?.request_title || 'Demande de carte consulaire',
      ...
      <div className="p-4 border-b border-gray-200 flex-shrink-0">
        <div className="flex justify-between items-center">
          ...
          <div className="space-x-2">
            ...
            <button type="submit" form="card-form" className="px-4 py-2 bg-green-600 text-white rounded-md">Enregistrer</button>
